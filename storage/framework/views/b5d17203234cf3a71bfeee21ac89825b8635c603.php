...
<div class="py-4">
    <div class="add-new-project bg-white card-body-content">
        ...
        <div class="form-main-wrap px-5 py-4">
            <form class="form" action="<?php echo e(route('add.new.dealer')); ?>" method="POST" id="becomeDoctorForm" enctype="multipart/form-data" class="w-100 mt-5 form-steps-main" id="form">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" class="w-100" name="phone_1" value="<?php echo e(old('phone_1')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" class="w-100" name="phone_2" value="<?php echo e(old('phone_2')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" class="w-100" name="phone_3" value="<?php echo e(old('phone_3')); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shinnyview_pk\resources\views/admin/prime-dealers/add-new-dealer.blade.php ENDPATH**/ ?>