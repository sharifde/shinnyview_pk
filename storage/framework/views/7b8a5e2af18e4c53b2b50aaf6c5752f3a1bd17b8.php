...
<div class="py-4">
    <div class="bg-white card-body-content">
        ...
        <form class="row px-4 py-4 form-main-wrap" action=<?php echo e(route('update.seller')); ?> id="seller" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shinnyview_pk\resources\views/admin/edit_seller_user.blade.php ENDPATH**/ ?>