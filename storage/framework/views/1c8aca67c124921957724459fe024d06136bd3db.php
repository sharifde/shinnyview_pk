...
<script type="text/javascript">
    $(function() {
        var table = $('.data-table').DataTable({
            ...
            ajax: {
                ...
                url: "<?php echo e(route('admin.packageplan.details')); ?>",
                data: function(d) {
    ...
    function updateStatus(id) {
            ...
            $.ajax({
                url: "<?php echo e(route('update.packageplan.status')); ?>",
                type: "POST",
                data: {
                    id: id
                      },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shinnyview_pk\resources\views/admin/package-plan/packageplans-list.blade.php ENDPATH**/ ?>