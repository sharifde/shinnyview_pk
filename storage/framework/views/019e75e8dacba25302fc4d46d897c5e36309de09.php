      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-4 col-xs-6">
          ...
          <ul>
            ...
            <li><a href="<?php echo e(url('/application-for-investment')); ?>">Investment Application</a></li>
            <li><a href="<?php echo e(url('/application-house-plots')); ?>">House &amp; Plot Application</a></li>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo e(url('/complaint-policy')); ?>">Complaint Policy</a></li>
                    </ul>
                </div>
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="row sv-apps">
                        ...
                        <div class="d-app">
                            ...
                            <img src="<?php echo e(asset('images/play-store.png')); ?>" alt="Google Play Store">
                            </a>
                        </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-6">
                        <div class="d-app">
                            ...
                            <img src="<?php echo e(asset('images/app-store.png')); ?>" alt="App Store">
                            </a>
                        </div>
                        </div>
                    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
          <div class="social-links">
           ...
           <?php /**PATH E:\xampp\htdocs\shinnyview_pk\resources\views/frontend/components/footer.blade.php ENDPATH**/ ?>