...
<div class="row mt-4">
  ...
  <div class="col-md-6 col-lg-4 mb-4">
    <div class="bg-theme-dark dashboard-tile py-3 px-3 d-flex flex-wrap align-items-center">
      ...
      <div class="ms-auto text-white text-end tile-detail">
        <h5 class="f-bold mb-0"><?php echo e($total_active_projects); ?></h5>
  ...
  <div class="col-md-6 col-lg-4 mb-4">
    <div class="bg-theme-dark dashboard-tile py-3 px-3 d-flex flex-wrap align-items-center">
      ...
      <div class="ms-auto text-white text-end tile-detail">
        <h5 class="f-bold mb-0"><?php echo e($total_upcoming_projects); ?></h5>
  ...
  <div class="col-md-6 col-lg-4 mb-4">
    <div class="bg-theme-dark dashboard-tile py-3 px-3 d-flex flex-wrap align-items-center">
      ...
      <div class="ms-auto text-white text-end tile-detail">
        <h5 class="f-bold mb-0"><?php echo e($total_active_dealers); ?></h5>
  ...
  <div class="col-md-6 col-lg-4 mb-4">
    <div class="bg-theme-dark dashboard-tile py-3 px-3 d-flex flex-wrap align-items-center">
      ...
      <div class="ms-auto text-white text-end tile-detail">
        <h5 class="f-bold mb-0"><?php echo e($total_inactive_dealers); ?></h5>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shinnyview_pk\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>