                                ...
                                <select name="city" class="p-city search-select">
                                    ...
                                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($c->id); ?>"
                                            <?php if(isset($cityid) && $cityid == $c->id): ?> selected="selected" <?php endif; ?>><?php echo e($c->name); ?>
                        ...
                        <?php if($p->boost == true): ?>
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <div class="default-card">
                                    <a href="<?php echo e(route('view-property', ['ptype' => $p->propertyType, 'stype' => $p->purpose, 'city' => $p->city, 'id' => $p->id, 'slug' => $p->slug])); ?>"
                                        class=" b-shadow">
                                        <div class="image">
                                            <img src="<?php echo e(asset('properties/gallery/' . $p->image)); ?>"
                                            ...
                                            <?php endif; ?>
                                            <div
                                                class="p-type <?php echo e(strtolower(str_replace(' ', '-', $p->property_type_name))); ?>">
                                                <?php echo e($p->property_type_name); ?> for <?php echo e($p->purpose); ?> </div>
                                        </div>
                                        ...
                                        <div class="additional-info">
                                            <div class="a-features"
                                                <?php if(empty($p->bedroom)): ?> style="width: 80%;" <?php endif; ?>
                                                title="<?php echo e($p->size); ?> <?php echo e($p->area); ?>"><i
                                                    class="fas fa-vector-square"></i> <span><?php echo e($p->size); ?>

                                                    <?php echo e($p->area); ?></span></div>
                                            <?php if($p->bedroom): ?>
                                                <div class="a-features"><i class="fas fa-bed"></i> <?php echo e($p->bedroom); ?> Bed
                                                </div>
                                            <?php endif; ?>
                                            <?php if($p->bath): ?>
                                                <div class="a-features"><i class="fas fa-bath"></i> <?php echo e($p->bath); ?>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shinnyview_pk\resources\views/frontend/boost-property.blade.php ENDPATH**/ ?>