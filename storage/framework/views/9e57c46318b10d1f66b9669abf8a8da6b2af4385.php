...
<script type="text/javascript">
    $(function() {
        var table = $('.data-table').DataTable({
            ...
            ajax: {
                ...
                url: "<?php echo e(route('admin.packageplan.requestdetails')); ?>",
                data: function(d) {
    ...
    function updateStatus(id) {
            ...
            $.ajax({
                url: "<?php echo e(route('update.packageplanrequest.status')); ?>",
                type: "POST",
                data: {
                    id: id
                      },
		...
		function updateIsapprove(id) {
            ...
            $.ajax({
                url: "<?php echo e(route('update.packageplanrequest.approve')); ?>",
                type: "POST",
                data: {
                    id: id
                      },
		...
		function updateIspaid(id) {
            ...
            $.ajax({
                url: "<?php echo e(route('update.packageplanrequest.statusispaid')); ?>",
                type: "POST",
                data: {
                    id: id
                      },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shinnyview_pk\resources\views/admin/package-plan/package-request-list.blade.php ENDPATH**/ ?>