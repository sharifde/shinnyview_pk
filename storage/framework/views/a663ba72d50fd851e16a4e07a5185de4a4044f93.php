...
<div class="py-4">
    <div class="add-new-project bg-white card-body-content">
        ...
        <div class="form-main-wrap px-5 py-4">
            <form class="form" action="<?php echo e(route('add.new.advert.plan')); ?>" method="POST" enctype="multipart/form-data" class="w-100 mt-5 form-steps-main" id="form">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shinnyview_pk\resources\views/admin/advert-plan/advert-plan.blade.php ENDPATH**/ ?>