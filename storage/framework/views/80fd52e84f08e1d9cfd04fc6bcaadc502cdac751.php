...
<script type="text/javascript">
    $(function() {
        var table = $('.data-table').DataTable({
            ...
            ajax: {
                ...
                url: "<?php echo e(route('admin.plan.details')); ?>",
                data: function(d) {
    ...
    function updateStatus(id) {
        ...
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    url: window.livewire_app_url + '/admin/delete-advert',
                    data: postData,
                    type: 'POST',
                    success: function(res) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shinnyview_pk\resources\views/admin/advert-plan/plans-list.blade.php ENDPATH**/ ?>