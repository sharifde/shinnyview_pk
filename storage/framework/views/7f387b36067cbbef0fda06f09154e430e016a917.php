...
<div class="py-4">
    <div class="add-new-project bg-white card-body-content">
        <div class="search-form-header bg-theme-dark">
            <h5 class="mb-0 text-white px-4 py-3 text-center f-medium">Add
        ...
        <?php if($message = Session::get('success')): ?>
            <div class="alert alert-success">
                ...
                <p>Package Plan Successfully Added.</p>
            </div>
        <?php endif; ?>
        <div class="form-main-wrap px-5 py-4">
            <form class="form" action="<?php echo e(route('save.package.plan')); ?>" method="POST" enctype="multipart/form-data" class="w-100 mt-5 form-steps-main" id="form">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="number" min="0" class="w-100" name="property">
...
unset($__errorArgs, $__bag); ?>
					 ...
					 <div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="number" min="0" class="w-100" name="price">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="number" min="0" class="w-100" name="days">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            <label class="f-medium mb-2">
                                No. of Pictures  <sup class="text-danger">*</sup>
                            </label>
                            <div class="position-relative">
                                <input type="number" min="0" class="w-100" name="picture">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="number" min="0" class="w-100" name="video_link" value="0">
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="number" min="0" class="w-100" name="feature_property">
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="number" min="0" class="w-100" name="boosted_property">
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" min="0" class="w-100" name="option1">
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" min="0" class="w-100" name="option2">
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" min="0" class="w-100" name="option3">
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" min="0" class="w-100" name="color">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shinnyview_pk\resources\views/admin/package-plan/addpackage-plan.blade.php ENDPATH**/ ?>