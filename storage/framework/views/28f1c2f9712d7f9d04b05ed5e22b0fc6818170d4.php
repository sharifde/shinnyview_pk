...
<div class="py-4">
    <div class="add-new-project bg-white card-body-content">
        ...
        <div class="form-main-wrap px-5 py-4">
            <form class="form" action="<?php echo e(route('update.dealer.details')); ?>" method="POST" id="becomeDoctorForm" enctype="multipart/form-data" class="w-100 mt-5 form-steps-main" id="form">
                <?php echo e(csrf_field()); ?>

                <input type="hidden" name="dealerID" value="<?php echo e($dealer->id); ?>">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" class="w-100" id="" name="d_name" value="<?php echo e($dealer->name); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="output-img d-flex flex-wrap border mt-2 pt-2 px-2">
                                ...
                                <div class="me-2 mb-2 position-relative view-added-image">
                                    ...
                                    <img width="70" height="70" src="<?php echo e(asset('storage/app')); ?>/<?php echo e($dealer->logo); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" class="w-100" name="phone_1" value="<?php echo e($dealer->phone_1); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" class="w-100" name="phone_2" value="<?php echo e($dealer->phone_2); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" class="w-100" name="phone_3" value="<?php echo e($dealer->phone_3); ?>">
                        ...
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <select name="status" id="" class="w-100">
                                    <option value="active" <?php if($dealer->status == 'active'): ?> selected <?php endif; ?>>Active</option>
                                    <option value="inactive" <?php if($dealer->status == 'inactive'): ?> selected <?php endif; ?>>Inactive</option>
                                </select>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shinnyview_pk\resources\views/admin/prime-dealers/edit-dealer.blade.php ENDPATH**/ ?>