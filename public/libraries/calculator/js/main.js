...
$(".container.calculator-main").addClass("container-light");
$(".calculator-main form").addClass("form-light");
$(".calculator-main form input").addClass("form-input-light");
...
// Theme system
$(".calculator-main input[type='checkbox']").change(function () {
    // dark theme
    if (this.checked) {
        //alert("dark");
        $(".calculator-main.container").removeClass("container-light");
        $(".calculator-main.container").addClass("container-dark");
        $(".calculator-main form").removeClass("form-light");
        $(".calculator-main form").addClass("form-dark");
        $(".calculator-main form input").removeClass("form-input-light");
        $(".calculator-main form input").addClass("form-input-dark");
    ...
    // light theme (default)
        ...
        //alert("light");
        $(".calculator-main.container").removeClass("container-dark");
        $(".calculator-main.container").addClass("container-light");
        $(".calculator-main form").removeClass("form-dark");
        $(".calculator-main form").addClass("form-light");
        $(".calculator-main form input").removeClass("form-input-dark");
        $(".calculator-main fcontainerform input").addClass("form-input-light");
