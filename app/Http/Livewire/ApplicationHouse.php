...
class ApplicationHouse extends Component
{
    public $full_name,$email,$cnic,$gender,$status,$address,$mobile,$intrested_in,$interested_in_details,$budget,
    $accept_term;
    public function render()
    {
        // $this->role_seller_id = 3;
        // $this->role_agent_id = 2;
        return view('livewire.application-house');
    }
