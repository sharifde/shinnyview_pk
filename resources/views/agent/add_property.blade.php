    ...
    <div class="py-4">
        <div class="bg-white card-body-content">
			...
			<h6 class="mb-0 text px-4 py-3 text-center f-medium" style="color:red">Total Property Allowed: 
				@if($package)
				({{ $total_sale_property+$total_rent_property+$total_lease_property }}/{{ $package->property }})
				@endif
			</h6>
				@php
                ...
                <form class="w-100 mt-5 form-steps-main" method="POST" id="form">
                    <div class="row form-steps-register property-check-data active" id="form_step_0">
                        ...
                        <div class="col-12 mb-4 property-checkbox parent-checkboxes d-flex flex-wrap">
                            ...
                            {{-- <div class="form-group-checkbox me-3 mt-1 p-type-plot">
                                <input type="radio" id="for_plot" value="3" name="property_type_id" data-type="plot">
                        ...
                        {{-- <div class="col-12 property-check-buttons" id="property-check-plot" style="display:none;">
                            <div class="w-100 mb-4 property-checkbox d-flex flex-wrap">
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Comercial_Plot" data-required="required" value="16" name="purpose_type_inner_id">
                                    <label for="Comercial_Plot">Comercial Plot </label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Residential_Plot" data-required="required" value="17" name="purpose_type_inner_id">
                                ...
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="plot_other" value="19" data-required="required" name="purpose_type_inner_id">
                    ...
                    <div class="row form-steps-register d-none" id="form_step_1">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    <input type="email" class="w-100" name="email" data-required="required" value="{{Auth::user()->email}}" readonly   />
                                    <div
                                        class="position-absolute field-icon d-flex
                                        align-items-center justify-content-center">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    <input type='tel' id="phone" class="w-100" name="phone_num" data-required="required" value="{{Auth::user()->company_phone_number}}" readonly />
                        ...
                        {{--<div class="col-md-6 col-lg-4 mb-4">
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative d-flex flex-column-reverse" wire:ignore>
                                    <select name="property_type_id" data-required="required" class="form-select-list w-100" onchange="propertyType(this.value)" placeholder="property_type_id" >
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    ...
                                    <small class="text-danger f-13">(Max {{$package->picture}} Gallery Images)</small>
                                </div>
                            </div>
                        </div>
						<div class="col-md-6 col-lg-4 mb-4">
					...
					<!--	<hr style="border: 5px solid #BC985F;">
                        ...
                        <table class="w-100" border-collpase="collapse" style="border: 1px solid lightgrey;">
                            ...
                            <tbody>
								@if(Auth::user()->role_type == 'Private Seller')
									@if($package_plan)
									   @php $i=0; @endphp
										@foreach($package_plan as $p_plan)
											@if($p_plan->name != 'Free')
								               @php $i++; @endphp
										<tr>
											<td class="py-2 px-3">
												<br>
												<p class="mb-3" style="margin-top: -10px;"><span style="background-color: {{ $p_plan->color }}; padding: 4px 25px;"><b style="color:white">{{ $p_plan->name }}</b></span> You will get <b>{{ $p_plan->days }}</b> Listings of your properties.<b style="float: right;">PKR: {{ $p_plan->price }}</b></p>
											...
											<td class="px-5 py-2">
												<div class="form-group-checkbox mb-2 text-center">
													<input type="checkbox" class="package" id="{{ $p_plan->name}}{{$p_plan->id }}" value="{{ $p_plan->price }}" name="plan_id">
													<label for="{{ $p_plan->name}}{{$p_plan->id }}"></label>
													<input type="text" value="{{$p_plan->id }}" name="package_id">
						   ...
						   @php $i=0; @endphp
							@foreach($advert_plan as $a_plan)
								...
								<!--		<hr style="border: 0.2px solid #BC985F;">
                                    ...
                                    <td class="px-5 py-2">
                                        <div class="form-group-checkbox mb-2 text-center">
                                            <input type="checkbox" class="addon" id="{{ $a_plan->name }}" value="{{ $a_plan->price.','.$a_plan->id }}" name="advertise">
                                            <label for="{{ $a_plan->name }}"></label>
											<input type="hidden" value="{{$a_plan->id }}" name="advertise_id">
                                        </div>
				 			...
				 			<div class="alert alert-danger">
								<h5 class="mb-0 text px-4 py-3 text-center f-medium">
					 			...
					 			<h6 class="mb-0 text px-4 py-3 text-center f-medium">
									...
									<a href="{{route('packages-details')}}">click here (Buy Now!)</a>
								</h6>
				 			</div>
						</div>
    				</div>	
