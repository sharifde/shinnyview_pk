...
@section('content')
    ...
    <div class="py-4">
        <div class="bg-white card-body-content">
            ...
            <div class="form-main-wrap px-5 py-4">
                ...
                <form class="w-100 mt-5 form-steps-main" method="POST" id="form" action="route{{ 'property.update.admin' }}">
                    <div class="row form-steps-register property-check-data active" id="form_step_0">
                        ...
                        <div class="col-12 mb-4 property-checkbox d-flex flex-wrap">
                            <div class="form-group-checkbox me-3 mt-1">
                                <input type="radio" id="for_sale" value="1" @if($property->purpose_id ==1) checked @endif name="purpose_id">
                                <label for="for_sale">For Sale</label>
                            </div>
                            <div class="form-group-checkbox me-3 mt-1">
                                <input type="radio" id="for_rent" value="2"  @if($property->purpose_id ==2) checked @endif name="purpose_id">
                                <label for="for_rent">For Rent</label>
                            </div>
                            <div class="form-group-checkbox me-3 mt-1">
                                <input type="radio" id="on_lease" value="3"  @if($property->purpose_id ==3) checked @endif name="purpose_id">
                        ...
                        <div class="col-12 mb-4 property-checkbox parent-checkboxes d-flex flex-wrap">
                            <div class="form-group-checkbox me-3 mt-1">
                                <input type="radio" id="for_residential" value="1" @if($property->property_type_id ==1) checked @endif name="property_type_id" data-type="home">
                                <label for="for_residential">Residential</label>
                            </div>
                            <div class="form-group-checkbox me-3 mt-1">
                                <input type="radio" id="for_commercial" value="2" @if($property->property_type_id ==2) checked @endif name="property_type_id" data-type="commercial">
                                <label for="for_commercial">Commercial</label>
                            </div>
                            {{-- <div class="form-group-checkbox me-3 mt-1">
                                <input type="radio" id="for_plot" value="3" name="property_type_id" @if($property->property_type_id ==3) checked @endif data-type="plot">
                                <label for="for_plot">Plot</label>
                            </div> --}}
                        </div>
                        <!-- For Home -->
                        <div class="col-xl-9 col-lg-10 property-check-buttons" id="property-check-home"  @if($property->property_type_id ==1) style="display:block;" @else style="display:none;" @endif>
                            <div class="w-100 mb-4 property-checkbox d-flex flex-wrap">
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="House" value="1" @if($property->purpose_type_inner_id ==1) checked @endif  name="purpose_type_inner_id">
                                    <label for="House">House</label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Flat" value="2" @if($property->purpose_type_inner_id ==2) checked @endif  name="purpose_type_inner_id">
                                    <label for="Flat">Flat</label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Uper_Portion" value="3" @if($property->purpose_type_inner_id ==3) checked @endif  name="purpose_type_inner_id">
                                    <label for="Uper_Portion">Uper Portion</label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Lower_Portion" value="4" @if($property->purpose_type_inner_id ==4) checked @endif  name="purpose_type_inner_id">
                                    <label for="Lower_Portion">Lower Portion</label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Farm_House" value="5" @if($property->purpose_type_inner_id ==5) checked @endif  name="purpose_type_inner_id">
                                    <label for="Farm_House">Farm House</label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Penthouse" value="6" @if($property->purpose_type_inner_id ==6) checked @endif  name="purpose_type_inner_id">
                                    <label for="Penthouse">Penthouse</label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Residential_Plot"  value="16"  @if($property->purpose_type_inner_id == 16) checked @endif name="purpose_type_inner_id">
                                    <label for="Residential_Plot"> Plot</label>
                                </div>

                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="File" value="18"  @if($property->purpose_type_inner_id == 18) checked @endif name="purpose_type_inner_id">
                                    <label for="File">File </label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Room" value="7" @if($property->purpose_type_inner_id ==7) checked @endif  name="purpose_type_inner_id">
                        ...
                        <div class="col-xl-9 col-lg-10 property-check-buttons" id="property-check-commercial"  @if($property->property_type_id ==2) style="display:block;" @else style="display:none;" @endif>
                            <div class="w-100 mb-4 property-checkbox d-flex flex-wrap">
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Office" value="9" @if($property->purpose_type_inner_id ==9) checked @endif name="purpose_type_inner_id">
                                    <label for="Office">Office </label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Shop" value="10" @if($property->purpose_type_inner_id ==10) checked @endif  name="purpose_type_inner_id">
                                    <label for="Shop">Shop</label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Wharehose " value="11" @if($property->purpose_type_inner_id ==10) checked @endif  name="purpose_type_inner_id">
                                    <label for="Wharehose ">Warehose </label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="factory" value="12" @if($property->purpose_type_inner_id ==12) checked @endif  name="purpose_type_inner_id">
                                    <label for="factory">Factory</label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Building " value="13" @if($property->purpose_type_inner_id ==13) checked @endif  name="purpose_type_inner_id">
                                    <label for="Building ">Building </label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Land" value="14" @if($property->purpose_type_inner_id ==14) checked @endif  name="purpose_type_inner_id">
                                    <label for="Land ">Land </label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Comercial_Plot"  value="16" @if($property->purpose_type_inner_id == 16) checked @endif name="purpose_type_inner_id">
                                ...
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Other" value="15" @if($property->purpose_type_inner_id ==14) checked @endif  name="purpose_type_inner_id">
                        ...
                        {{-- <div class="col-12 property-check-buttons" id="property-check-plot"  @if($property->property_type_id ==3) style="display:block;" @else style="display:none;" @endif>
                            <div class="w-100 mb-4 property-checkbox d-flex flex-wrap">
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Comercial_Plot" value="16" @if($property->purpose_type_inner_id ==15) checked @endif name="purpose_type_inner_id">
                                    <label for="Comercial_Plot">Comercial Plot </label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Residential_Plot" value="17" @if($property->purpose_type_inner_id ==16) checked @endif name="purpose_type_inner_id">
                                    <label for="Residential_Plot">Residential Plot</label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="Plot_File " value="18" @if($property->purpose_type_inner_id ==17) checked @endif name="purpose_type_inner_id">
                                    <label for="Plot_File ">Plot File </label>
                                </div>
                                <div class="form-group-checkbox me-3 mt-2">
                                    <input type="radio" id="plot_other" value="19" @if($property->purpose_type_inner_id ==18) checked @endif name="purpose_type_inner_id">
                                    <label for="plot_other">Other</label>
                                </div>
                            </div>
                        </div> --}}
                    ...
                    <div class="row form-steps-register d-none" id="form_step_1">
                            ...
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative d-flex flex-column-reverse">
                                    ...
                                    @foreach ($province as $p)
                                        <option <?php echo  $property->province_id == $p->id? 'selected' :''?> value="{{ $p->id }}">{{ $p->name }}</option>
                                    @endforeach
                                ...
                                <div class="position-relative d-flex flex-column-reverse">
                                    <select name="city_id"  id="select2-city" class="form-select-list w-100"  onchange="getAddress(this.value)" >
                                        {{-- <option selected disabled>Select City</option> --}}
										 @foreach ($cities as $c)
                                        	<option <?php echo  $property->city_id == $c->id? 'selected' :''?> value="{{ $c->id }}">{{ $c->name }}</option>
                                    	@endforeach
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    <input type="email" class="w-100" name="email"  value="{{$property->email }}"   />
                                    <div
                                        class="position-absolute field-icon d-flex
                                        align-items-center justify-content-center">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    <input type='tel' id="phone" class="w-100" name="phone_num" value="{{$property->phone_num }}"/>
                    ...
                    <div class="row form-steps-register d-none" id="form_step_2">
                            ...
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div
                                        class="position-absolute field-icon d-flex
                                    align-items-center justify-content-center">
                                        <img src="{{ asset('images/svg/selection.svg') }}" alt="size" height="20px" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        {{--<div class="col-md-6 col-lg-4 mb-4">
                            <div class="form-elements-wrap">
                                <label class="f-medium mb-2">
                                    Property Type <sup class="text-danger">*</sup>
                                </label>
                                <div class="position-relative d-flex flex-column-reverse" wire:ignore>
                                    <select name="property_type_id" class="form-select-list w-100" onchange="propertyType(this.value)" placeholder="property_type_id" >
                                        <option selected value="" disabled>Select Property Type</option>
                                        @foreach($propert_type as $pt):
                            ...
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div
                                        class="position-absolute field-icon d-flex
                                    align-items-center justify-content-center">
                                        <img src="{{ asset('images/svg/bed.svg') }}" alt="bedroom" height="25px" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col mb-3 bathroom">
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    ...
                                    maxlength="2" value="{{$property->bath}}"
                                         />
                                    <div
                                        class="position-absolute field-icon d-flex
                                    align-items-center justify-content-center">
                                        <img src="{{ asset('images/svg/bath-tub.svg') }}" alt="Bathroom" height="20px" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col mb-3 airport">
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    <input type="number" value="{{$property->airport_km}}" class="w-100" name="airport_km"
                                    />
                                    <div
                                        class="position-absolute field-icon d-flex
                                        align-items-center justify-content-center">
                        ...
                        {{--<div class="col-md-6 col-lg-4 mb-4">
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="w-100" name="plot_number" minlength="1"
                                       />
                                    <div
                                        class="position-absolute field-icon d-flex
                                    align-items-center justify-content-center">
                    ...
                    <div class="row form-steps-register d-none" id="form_step_3">
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    <input type="text" value="{{$property->price}}" class="w-100" name="price"
                                    />
                                    <div
                                        class="position-absolute field-icon d-flex
                                        align-items-center justify-content-center">
                            ...
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="output-img d-flex flex-wrap border mt-2 pt-2 px-2">
                                        ...
                                        <img width="50" height="50" src="{{asset('properties/gallery/'.$property->image)}}" />
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="output-img d-flex flex-wrap border mt-2 pt-2 px-2 ">
                                        @foreach($property->gallery as $key=>$fg)
                                        <div class="me-2 mb-2 position-relative view-added-image">
                                        <input type="hidden" name="imagesdb[]" value="{{ $fg->name }}">
                                        <img width="50" height="50" src="{{asset('properties/gallery/'.$fg->name)}}" />
                                        <span data-index="{{$key}}" class='remove-btn-img position-absolute rounded-circle' type='button'>
                                            <i class='bi bi-x-circle-fill'></i></span>
                                        </div>
                                        @endforeach
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    <input type="text" name="youtube_link" value="{{$property->youtube_link}}" placeholder="Youtube Link"
                        ...
                        <div class="col-12 col-lg-10 col-xl-9 mb-4">
                            <div class="form-elements-wrap">
                                ...
                                <div class="position-relative">
                                    <textarea class="w-100 d-block" name="description" cols="4" rows="6">{{$property->description}}</textarea>
                    ...
                    <input type="hidden" value="{{$property->city_id}}" id="city_id">
                    <input type="hidden" value="{{$property->address_id}}" id="address_id">
    ...
    <script>
        ...
        var iti = window.intlTelInput(input, {
            utilsScript: "{{asset('libraries/intel-validation/utils.js')}}",
    ...
    <script>
      ...
      submitHandler: function(form) {
       ...
       // $('#send_form').html('Sending..');
        $.ajax({
          url: "{{route('property.update.admin')}}" ,
          type: "POST",
          data: formData,
          processData: false,
         contentType: false,
