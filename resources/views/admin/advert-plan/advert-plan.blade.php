    ...
    <div class="add-new-project bg-white card-body-content">
        ...
        @if ($message = Session::get('success'))
            <div class="alert alert-success">
                ...
                <p>Advert Plan Successfully Added.</p>
            </div>
        @endif
        <div class="form-main-wrap px-5 py-4">
            <form class="form" action="{{ route('add.new.advert.plan') }}" method="POST" enctype="multipart/form-data" class="w-100 mt-5 form-steps-main" id="form">
                {{ csrf_field() }}
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-elements-wrap">
                            <label class="f-medium mb-2">
                               Guide Image <sup class="text-danger">*</sup>
                            </label>
                            <div class="position-relative">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" class="w-100" name="days">
                                @error('days') 
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" class="w-100" name="size">
                                @error('size') 
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
					...
					<div class="col-md-3 col-sm-6 col-xs-12 mt-3">
                        <div class="form-elements-wrap">
                            ...
                            <div class="position-relative">
                                <input type="text" class="w-100" name="color">
                                @error('color') 
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
