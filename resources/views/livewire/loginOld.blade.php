                    ...
                    <div class="col-lg-7 col-md-8">
                        ...
                        <div class="form-group-checkbox mb-4">
                            ...
                            <label class="d-flex align-items-center" for="privacy_policy">
                                <span class="ps-1">I have read and agree to the Shinnyview Terms & Conditions</span>
                            </label>
                        </div>
						...
						<br>
						<div class="new-user">
								New User? <a style="color: #BC985F" href="https://phpscriptpoint.com/cc/realspoint/customer/register" class="link">Register as Individual Client</a>
								<br>
