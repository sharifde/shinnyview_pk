    ...
    <head>
        ...
        @endif
		 ...
		 @if ($route != 'view-property')    
            ...
            <meta name="description" content={{ isset($description) ? $description :"Shinnyview.com is Pakistan's Best Property Website, Allowing You to Buy, Rent, and Sell Properties across Pakistan."}}>
        @endif
...
<script>
  ...
  gtag('config', 'G-XBT05VCYLH');
    ...
    <body>
        ...
        <script type="text/javascript" src="{{asset('libraries/sweet-alert/sweet_alert.min.js')}}"></script>
