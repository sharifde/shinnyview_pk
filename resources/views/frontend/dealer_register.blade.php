        ...
        <div class="w-100 mb-0 border-custom radius-y-12">
            <div class="progress-container pb-5">
                <ul class="progress-steps ps-0">
                    ...
                    {{--<li data-target="form_step_1">Personal Details</li>--}}
                    {{--<li data-target="form_step_2">Signature</li>--}}
            ...
            <div class="px-sm-4 px-3 py-4 form-steps-main">
                ...
                <div class="row form-steps-register d-flex active" id="form_step_0">
                    ...
                    {{-- <div class="search-form-fields col-md-6 mb-3">
                        <label class="f-medium">Applicant CNIC Number<span class="ms-auto float-end me-2 rtl-name">شناختی کارڈ نمبر</span></label>
                        <input type="number" class="w-100" minlength="11"   name="cnic"/>
                    </div>
                    <div class="search-form-fields col-md-6 mb-3">
                        <label class="f-medium">Applicant Date of Birth <sup class="text-danger f-14">*</sup>
                            <span class="ms-auto float-end me-2 rtl-name">تاریخ</span></label>
                        </label>
                        <input type="date" class="w-100"   required="required" name="date_birth"/>
                    </div> --}}
                </div>
                <!-- Step 1 -->
                {{-- <div class="row form-steps-register d-none" id="form_step_1">
                    <div class="search-form-fields col-md-6 mb-3">
                        ...
                        <input type="text" class="w-100" minlength="2"  id="second_name"  required="required"  />
                    </div>
                    <div class="search-form-fields col-md-6 mb-3">
                        <label class="f-medium">Email address
                            <sup class="text-danger f-14">*</sup>
                        ...
                        <input type="email" class="w-100"  id="second_email"  required="required" />
                    </div>
                    <div class="search-form-fields col-md-6 mb-3">
                        <label class="f-medium">Phone <sup class="text-danger f-14">*</sup>
                            <span class="ms-auto float-end me-2 rtl-name">فون نمبر</span>
                        </label>
                        <input type="number" class="w-100"  id="second_phone"  required="required" />
                    </div>
                    <div class="search-form-fields col-md-6 mb-3">
                        <label class="f-medium">Applicant CNIC Number<span class="ms-auto float-end me-2 rtl-name">شناختی کارڈ نمبر</span></label>
                        <input type="number" class="w-100" minlength="11"   name="cnic"/>
                ...
                {{--<div class="row form-steps-register d-none" id="form_step_1">
                    <div class="search-form-fields col-md-6 mb-3">
                        ...
                        <input type="text" class="w-100"   required="required" name="print_name" />
                    </div>
                    <div class="search-form-fields col-md-6 mb-3">
                        <label class="f-medium">Date<sup class="text-danger f-14">*</sup>
                            <span class="ms-auto float-end me-2 rtl-name">تاریخ</span>
                        </label>
                        <input type="date" class="w-100"   required="required" name="signature_date" />
                    </div>
                </div>--}}
                <!-- Step 3 -->
										...
										<tr>
											...
											<td class="px-5 py-2">
												<div class="form-group-checkbox mb-2 text-center">
													<input type="radio" class="package" id="{{ $p_plan->name}}{{$p_plan->id }}" value="{{ $p_plan->price }}" name="plan_id">
    ...
    $('#next-trigger').click(function() {
        ...
        if($('#search-form-request-cd').is(":visible")){
            ...
            if(is_verified==true && $('#register-email').val() == reg_email ){
                ...
                $.ajax({
                    url: "{{route('dealer.verfication_code')}}",
                    type: "post",
                    data: formData,
                    processData: false,
                    contentType: false,
