         ...
         <div class="mainMenu">
             ...
             <div class="accordion w-100" id="accordionMenu">
                        ...
                        <div class="accordion-body">
                           ...
                           <ul class="inner-menu list-unstyled mb-3">
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/residential/house-for-sale')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>House For Sale
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/residential/apartment-for-sale')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>Apartment For Sale
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/residential/plot-for-sale')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>Plot For Sale
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/residential/farmhouse-for-sale')}}" class="text-decoration-none tx-color inner-link">
                           ...
                           <ul class="inner-menu list-unstyled mb-0">
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/commercial/office-for-sale')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>Office For Sale
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/commercial/shop-for-sale')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>Shop For Sale
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/commercial/warehouse-for-sale')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>Plot For Sale
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/commercial/plot-for-sale')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>Warehouse For Sale
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/commercial/builing-for-sale')}}" class="text-decoration-none tx-color inner-link">
                 ...
                 <div class="accordion-item">
                     ...
                     <div id="collapseTwo" class="accordion-collapse inner-responsive-collapse  collapse" aria-labelledby="headingTwo"
                        ...
                        <div class="accordion-body">
                           ...
                           <ul class="inner-menu list-unstyled mb-3">
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/residential/house-for-rent')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>House For Rent
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/residential/apartment-for-rent')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>Apartment For Rent
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/residential/room-for-rent')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>Room For Rent
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/residential/farmhouse-for-rent')}}" class="text-decoration-none tx-color inner-link">
                           ...
                           <ul class="inner-menu list-unstyled mb-0">
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/commercial/office-for-rent')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>Office For Rent
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/commercial/shop-for-rent')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>Shop For Rent
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/commercial/building-for-rent')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>Building For Rent
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/commercial/warehouse-for-rent')}}" class="text-decoration-none tx-color inner-link">
                 ...
                 <div class="accordion-item">
                     ...
                     <div id="collapseThree" class="accordion-collapse collapse  inner-responsive-collapse" aria-labelledby="headingThree"
                        ...
                        <div class="accordion-body">
                           <ul class="inner-menu list-unstyled mb-3">
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/residential/lease')}}" class="text-decoration-none tx-color inner-link">
                                    <i class="bi bi-chevron-double-right me-2 txb-color"></i>Residential Lease
                                 </a>
                              </li>
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/commercial/lease')}}" class="text-decoration-none tx-color inner-link">
                  ...
                  <div class="accordion-item">
                     ...
                     <div id="collapseFour" class="accordion-collapse collapse inner-responsive-collapse" aria-labelledby="headingFour"
                        ...
                        <div class="accordion-body">
                           <ul class="inner-menu list-unstyled mb-0">
                              <li class="inner-parent mb-1">
                                 <a href="{{url('/commercial/land')}}" class="text-decoration-none tx-color inner-link">
               ...
               <ul class="px-0 w-100">
                  ...
                  <li  class="mb-2">
                     <a href="{{url('/')}}/blog" target="_blank">Blogs</a>
                  </li>
                  <li  class="mb-2">
                     <a href="{{route('dealer.signup')}}">Register as Dealer</a>
                  </li>
                  <li  class="mb-2">
                     <a href="{{route('create_property')}}">Sell Your Property</a>
                  </li>
               </ul>
           </div>
        </div>
